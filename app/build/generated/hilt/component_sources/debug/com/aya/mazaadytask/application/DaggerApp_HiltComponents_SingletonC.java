...
public final class DaggerApp_HiltComponents_SingletonC {
  ...
  private static final class SingletonCImpl extends App_HiltComponents.SingletonC {
    ...
    private Provider<MovieApis> provideApiServiceProvider;
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.provideApiServiceProvider = DoubleCheck.provider(new SwitchingProvider<MovieApis>(singletonCImpl, 1));
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.aya.data.repository.MovieRepositoryImpl 
          return (T) new MovieRepositoryImpl(singletonCImpl.provideApiServiceProvider.get(), singletonCImpl.movieDao());

          case 1: // com.aya.data.api.MovieApis 
          ...
          case 4: // com.aya.data.database.AppDatabase 
