...
public abstract class Hilt_ListMovieFragment<B extends ViewBinding, VM extends ViewModel> extends BaseFragment<B, VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ListMovieFragment_GeneratedInjector) this.generatedComponent()).injectListMovieFragment(UnsafeCasts.<ListMovieFragment>unsafeCast(this));
    }
  }
